...
namespace Homework
{
    public class RestaurantFormCategoryPresentationModel : INotifyPropertyChanged
    {
        ...
        public void ClearCategoryData()
        {
            ...
            _model.GetComputeModel().SetDeleteCategoryEnable(false);
            _categoryName = "";
        ...
        public void ChangeEditCategoryMode(int index)
        {
            ...
            if (index > -1)
            {
                ...
                _model.JudgeDeleteCategoryEnable(index);
                _enterCategoryEnable = false;
        ...
        public void EnterCategory(int index)
        {
            ...
            else
            {
                ...
                _model.GetComputeModel().SetDeleteCategoryEnable(true);
            }
        }
